...
export default function AnalisiQualita() {
  ...
  const loadData = async () => {
    try {
      ...
      console.error('[AnalisiQualita] loadData error:', err);
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-6">
        <div className="max-w-7xl mx-auto space-y-6">
          <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Analisi Qualità Fastweb</h1>
              <p className="text-sm text-gray-500">Ultimo ranking qualità aggiornato sull’ultimo batch disponibile del periodo selezionato.</p>
            </div>
          ...
          <section>
            ...
            <Card title="Legenda punteggi qualità" className="mt-6">
